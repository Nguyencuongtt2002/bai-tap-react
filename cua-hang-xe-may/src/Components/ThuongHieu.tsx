...
import { searchSanPham } from '../services/sanphamService'

const ThuongHieu: React.FC = () => {
    ...
    const obj = {
        ...
        minGia: null,
        maxGia: null,
        maThuongHieu: Number(id),
        maLoaiSanPham: null,
    };
    console.log(obj)
    const danhmuc = async () => {
        const res = await searchSanPham(obj)
        setData1(res.data)
    };
                            ...
                            <div className="row">
                                {data1.map((item, index) => (
                                    <div className="col-md-4 mb-3" key={item.maSanPham} style={{ boxShadow: "0 0 8px rgba(0,0,0,0.2)" }}>
                                        ...
                                        <input className="btn_muangay" type="button" value="MUA NGAY" />
                                        <p
                                            className="mt-2 mb-0"
